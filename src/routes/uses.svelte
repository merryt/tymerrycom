<div>
	...
	<h2>What do I use daily?</h2>
	<strong>Physical Things</strong>
	<ul>
		<li>
			<strong>Tom Bign Synapse</strong> - All my stuff when I travel location to location is stored in
		...
		<li>
			<strong>Asus ROG g14</strong> - My daily driver computer is a 14 inch Asus laptop. I originally
		...
		<li>
			<strong>Nexstand</strong> - This is a knock off roost stand. Inhindsight I would have given the
	...
	<ul>
		<li>
			<strong>Anki</strong> - Open source flashcard program. I use it on both computer + phone. I throw
			small facts that I need to recall quickly in there and drill myself daily
		</li>
		<li>
			<strong>Memrise</strong> - I previously used duolingo + anki for vocab, but I have been enjoying
